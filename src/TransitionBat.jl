...
export solve_transition_bat, StructTransOutputBat

mutable struct StructTransOutputBat
...
"""
    solve_transitio_bat(P::StructAllParams, DL::StructAllData, M::StructMarketOutput, S::StructSteadyStateBat, Subsidy::Int, config::ModelConfig, G::String)
...
"""
function solve_transition_bat(P::StructAllParams, DL::StructAllData, M::StructMarketOutput, S::StructSteadyStateBat, Subsidy::Int, config::ModelConfig, G::String)
    # set st 
